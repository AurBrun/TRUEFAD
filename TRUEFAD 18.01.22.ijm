	...
	if (IMGtype=="RGB MHC fluorescence of SKMDC cells") {;
		...
		Dialog.addSlider("Segmentation tolerance", 1, 50, 25);
...
// Preprocessing for fluorescence
	...
	rename("A");
		...
		wait(100*SPD);
		call("inra.ijpb.plugins.MorphologicalSegmentation.segment", "tolerance=30", "calculateDams=true", "connectivity=0");
		wait(3500*SPD);
...
// Preprocessing for phase contrast
	...
	// Segmentation
		...
		call("inra.ijpb.plugins.MorphologicalSegmentation.setGradientRadius", "1");
		wait(100*SPD);
		call("inra.ijpb.plugins.MorphologicalSegmentation.segment", "tolerance=80.0", "calculateDams=true", "connectivity=8");
		wait(3500*SPD);
		call("inra.ijpb.plugins.MorphologicalSegmentation.setDisplayFormat", "Catchment basins");
		wait(300*SPD);
		call("inra.ijpb.plugins.MorphologicalSegmentation.createResultImage");
...
// Make the Result table for the current image
	Table.showArrays("Diameters", CorLabel, DiameterX);
